...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return ColorScheme(
      ...
      onSecondary: Color(0xFFB77A3B), // Text color on secondary
      secondaryContainer: Color(0xFFF4F4F4), // Secondary container color
      ...
      surface: Colors.grey[100]!, // Surface color (light theme)
