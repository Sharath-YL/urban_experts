...
import 'package:provider/provider.dart';
  ...
  void showAmountBottomSheet(BuildContext context, String itemId, String optionPlacename) {
              ...
              Row(
                ...
                children: [
                  AppTextButton(
                    text: "100",
                    onTap: () {
                      provider.updateAdditionalAmount(itemId, optionPlacename, 100);
                      Navigator.pop(context);
                  ...
                  AppTextButton(
                    text: "200",
                    onTap: () {
                      provider.updateAdditionalAmount(itemId, optionPlacename, 200);
                      Navigator.pop(context);
                    },
                  ),
                  AppTextButton(
